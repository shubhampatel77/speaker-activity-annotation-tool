...
def main():
    original_videos_path = '../dataset/original_videos'
    tracked_videos_path = '../dataset/annotations/tracked_videos'
    tracks_path = '../dataset/annotations/tracks'
    ...
    for filename in successful:
        ...
        input_video_path = f'../dataset/original_videos/{filename}.mp4'
        output_json_path = f'../dataset/annotations/tracks/{filename}.json'
        ...
        # output_video_path = '../data/annotations/videos/{filename}.mp4'
        # output_video_path = f'../data/annotations/tracked_videos/{filename}.mp4'
        # create_video_from_json(input_video_path, output_json_path, output_video_path)
